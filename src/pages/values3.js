...
class Values3 extends React.Component{
  constructor(props){
    super(props);
    this.state={
      ...
      {(window.innerWidth >= 1024) ? <HeaderDesktop appState={this.props}>
        ...
        <div id='value-content'>
          ...
          <div id='value-value'>
            ...
            <img id='arrow_values' src={arrow} onClick={()=>{(this.state.counter < 6) ?  this.setState({counter: this.state.counter + 1}): null }} />
...
export default connect(mapStateToProps, mapDispatchToProps)(Values3)
